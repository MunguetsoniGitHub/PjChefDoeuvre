...
export const Footer = () => {
    ...
    return (
        <footer className="bg-white text-black py-6 gap-6">

        <div className="flex sm:flex flex-row sm:flex-row flex-wrap sm:flex-wrap justify-center py-8 h-full ">

          <div className="bg-black shadow-md rounded-lg px-12 py-4 text-center flex flex-col w-1/3 ">
