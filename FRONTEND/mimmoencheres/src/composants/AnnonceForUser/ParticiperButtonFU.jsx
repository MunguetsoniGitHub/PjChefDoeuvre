...
const ParticiperButton = ({ 
  // annonceId, utilisateurId, setParticipated 
  handleInscription, isParticipant}) => {
  ...
  return (
    <button
      // onClick={handleParticipate} className={`py-2 px-4 rounded mt-4 ${participating ? 'bg-green-500 hover:bg-green-700' : 'bg-red-500 hover:bg-red-700'} text-white font-bold`}
      onClick={handleInscription} disabled={isParticipant}
