  ...
  return (
    <div className="flex w-screen h-screen h-full bg-white overflow-hidden">
      ...
      <div className="w-full h-screen flex flex-col md:flex-row">
        ...
        <div 
          className={`h-screen w-full md:w-1/2 bg-cover bg-center bg-fixed  flex items-center justify-center ${isMobile ? 'p-6 overflow-y-scroll ' : 'rounded-r-full '}`}
          style={{ backgroundImage: 'url("https://res.cloudinary.com/maecd11/image/upload/v1720176205/maedev/aoh44txcf6vrfxvlj1gu.jpg")' }}
        >
          {/* Formulaire d' inscription en mode responsive */}
        ...
        {/* Formulaire d'inscription en mode desktop, caché en mode responsive */}
